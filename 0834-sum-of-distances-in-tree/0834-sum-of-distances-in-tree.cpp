// formula childAns = parentAns - x +(n-x)
// x is a connected subtree of child 
//  for ex 0 ka ans = 8
// and for node 2 = 8(parent of 2 that is 0 and that ans is 10) - 4(connected node of 2) + (6-4) = 8- 4+2 = 6
// T.C & S.C = O(N)
